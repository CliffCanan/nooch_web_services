        ...
        public static synapseV3checkUsersOauthKey refreshSynapseV3OautKey(string oauthKey)
        {
            ...
            try
            {
                ...
                if (synCreateUserObject != null)
                {
                    ...
                    try
                    {
                            ...
                            (refreshResponse["success"] != null && Convert.ToBoolean(refreshResponse["success"])))
                        {
                            ...
                            {
                                Logger.Info(
                                    "MDA -> synapseV3checkUsersOauthKey - SUCCESS From Synapse and Successfully added to Nooch DB - " +
                            ...
                            {
                                Logger.Error(
                                    "MDA -> synapseV3checkUsersOauthKey FAILED - Error saving new key in Nooch DB - " +
                        ...
                        {
                            Logger.Error(
                                "MDA -> synapseV3checkUsersOauthKey FAILED - Error from Synapse service, no 'success' key found - " +
                                "Original Oauth Key: [" + oauthKey + "]");
                ...
                else
                {
                    ...
                    Logger.Error(
                                   "MDA -> synapseV3checkUsersOauthKey FAILED -  no record found for given oAuth key found - " +
